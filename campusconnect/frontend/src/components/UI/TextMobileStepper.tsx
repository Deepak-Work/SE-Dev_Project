  ...
  return (
    <Box sx={{ m: 1 }}>
      <NewsletterElement
        ...
        clubId={clubId}
        clubImage={clubImage}
        postId={clubPosts[activeStep].id}
        title={clubPosts[activeStep].title}
        timePosted={clubPosts[activeStep].time_posted}
        author={clubPosts[activeStep].author}
        summary={clubPosts[activeStep].summary}
      />
      <MobileStepper
        variant="dots"
        steps={maxSteps}
